...
Documentation Validation (PSG-003)
     ↓
Query-Based Compilation (PLD-004)
```
...
7. **Query-Based Integration**: Seamless integration with PLD-004's query system
        ...
        let source = r#"
            ...
            module UserAuth {
                ...
                section internal {
                    ...
                    /// @effects [AI.ModelInference, Database.Query, Audit.Log]
                    @responsibility "Calculates fraud risk score using ML models"
...
### 6. Query-Based Compilation Integration (PLD-004)
...
4. **[PLD-004]** Query-Based Compiler Architecture
