...
impl ModuleResolver {
    ...
    fn resolve_smart_module_directory(
        ...
        // Example: capabilities/UserManagement.prism
    ...
    fn resolve_capability_directory(
        ...
        // Example: user-management/UserAuth.prism, payment/ProcessPayment.prism
    ...
    fn resolve_node_modules_style(
        ...
        loop {
            ...
            if self.file_system.exists(&prism_modules) {
                let candidate = prism_modules.join(format!("{}.prism", module_path));
...
impl ResolutionError {
    ...
    fn suggest_resolution_fixes(&self, module_path: &str, strategy: &ResolutionStrategy) -> String {
        match strategy {
            ResolutionStrategy::SmartModuleDirectory => {
                format!("Try creating module at capabilities/{}.prism or modules/{}.prism", module_path, module_path)
            }
            ResolutionStrategy::NodeModulesStyle => {
            ...
            match strategy {
                ResolutionStrategy::SmartModuleDirectory => {
                    ...
                    file_operations.push(FileOperation::BatchDirectoryScan {
                        ...
                        patterns: group_specs.iter().map(|s| format!("{}.prism", s.module_path)).collect(),
                    });
                }
                ResolutionStrategy::NodeModulesStyle => {
...
mod integration_tests {
    ...
    fn test_real_filesystem_resolution() {
        ...
        // Create test module
        let user_management_path = capabilities_dir.join("UserManagement.prism");
    ...
    fn dependencies(&self, input: &Self::Input) -> Vec<QueryDependency> {
        vec![
            QueryDependency::FileSystem {
                patterns: vec![
                    format!("capabilities/{}.prism", input.module_path),
                    format!("modules/{}.prism", input.module_path),
